    ...
    <div class="container">
        <!-- Body Welcome -->
            ...
            <div class="embed-responsive embed-responsive-16by9 d-flex justify-content-center">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7hLttW9UFAw" allowfullscreen></iframe>
            </div>
            <section class="text-justify">
                <h4 class="mt-4 fw-bold">History:</h4>
                <p>
                    The earliest traces of silver have been found dating back to the 10th century, when Bohemia already had been in the crossroads of long-distance trade for many centuries. Silver dinars have been discovered belonging to the period between 982 and 995 in the settlement of Malín, which is now a part of Kutná Hora.
                        The town began in 1142 with the settlement of Sedlec Abbey, the first Cistercian monastery in Bohemia. The Cistercian order based in the Sedlec Monastery was brought from the Imperial immediate Cistercian Waldsassen Abbey in Bavaria, Germany, close to the border with the Czech Republic. By 1260, German miners began to mine for silver in the mountain region, which they named Kuttenberg, and which was part of the monastery property. 
                    The name of the mountain is said to have derived from the monks' cowls (the Kutten) or from the word mining (kutání in old Czech).

                </p>
                <h4 class="mt-4 fw-bold">Middle Ages:</h4>
                <p>
                    From the 13th to 16th centuries, the town competed with Prague economically, culturally, and politically Under Abbot Heinrich Heidenreich [de], the territory greatly advanced due to the silver mines which gained importance during the economic boom of the 13th century. 
                    <span id="dots">...</span>
                    <span id="more" style="display: none;">
                        In 1300, King Wenceslaus II of Bohemia issued the new royal mining code Ius regale montanorum (also known as Constitutiones Iuris Metallici Wenceslai II). This was a legal document that specified all administrative as well as technical terms and conditions necessary for the operation of mines.[6] Prague groschen were minted between 1300 and 1547/48. 
                        In December 1402, the town was sacked by King Sigismund after the imprisonment of Wenceslaus IV. It was heavily defended by its residents. After several bloody skirmishes, Sigismund prevailed and forced the defenders to march to Kolín and kneel in subjugation. Although Sigismund was successful in his conquest, his hetman Markvart of Ulice (German: Markvart von Aulitz) died after being struck by an arrow during the siege on 27 December. 
                    ...
                    <button onclick="myFunction()" id="myBtn" class="btn btn-info">ReadMore</button>
                </p>
            </section>
            <div class="text-center mt-2">
            ...
            <div class="embed-responsive embed-responsive-16by9 d-flex justify-content-center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d41077.026641377306!2d15.247043987620108!3d49.949208928667765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470c41050983008f%3A0x400af0f66154f30!2sKutna%20Hora!5e0!3m2!1sen!2scz!4v1638638150861!5m2!1sen!2scz" width="400" height="200" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
