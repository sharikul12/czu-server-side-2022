<?php
    ...
    if(isset($_POST['submit']))
	{
        ...
        $sql = "SELECT id,uname FROM users WHERE uemail = '$email' and upassword = '$md5pass'";
    ...
    <div class="container col-4">
        <form class="mt-4 form-control shadow mb-4" method="post" action="">
            ...
            <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="formCheck" name="setCookie">Remember</label>
            </div>
            <div class="col mb-3">
                <a href="#" class="">Forget Password ?</a> <br>
                <span>Dont Have An acocunt?</span>
                <a href="./signup.php">Create An acocunt</a>
            </div>
            <button class="btn btn-primary mb-5" type="submit" name="submit"> Login</button>
