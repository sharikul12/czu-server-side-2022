...
<body>
    ...
    <div class="container">
        <div class="d-flex flex-wrap mt-4 mb-4 ">
            <div class="me-md-4">
              <img class="rounded img-fluid img-responsive img-thumbnail" src="./src/img/tripty.jpeg" alt="">
            </div>
            <div class="col-md-6 col-sm-12">
                <h3>Shahina islam Tripty</h3>
                <span>M.Sc. in System Enginnering and Informatics</span>
                <br>
                <span>Ceska Zemedelska Univerzita</span>
                <br>
        ...
        <div class="col-md-12 col-sm-12">
            <h4>About Me</h4>
            <hr>
            <p class="col-md-10">I am a punctual and motivated individual who is able to work in a busy environment and produce high standards of work. I am an excellent team worker and am able to take instructions from all levels and build up good working relationships with all colleagues. I am flexible, reliable and possess excellent time keeping skills.</p>
        </div>
        <hr>
        <div class="col-md-12 col-sm-12">
            <h4>Experiances</h4>
            <hr>
            <p class="col-md-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis ab rem temporibus optio aspernatur magnam sunt dolorem aliquam accusamus perferendis deleniti assumenda modi, ipsam, a iusto odio similique. Quasi, doloremque.</p>
        </div>
