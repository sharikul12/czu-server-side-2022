...
<head>
    ...
    <title>Cultures of Kutna Hora</title>
</head>
    ...
    <div class="container">
        <!-- Body Welcome -->
            <div class="text-center mt-2">
              <h1 class="text-uppercase"> <u>Cultures of Kutna Hora</u> </h1>
              <p class="">
            ...
            <div class="d-flex flex-wrap justify-content-center">
                <div class="col-md-2 col-sm-2 me-md-4 me-sm-4">
                  <img class="col-md-12 col-sm-12 rounded img-fluid img-responsive " src="./src/img/mirrormaze.jpg" alt="">
                </div>
                <div class="col-md-9 col-sm-9">
                    <h5>Mirror Maze</h5>
                    <span>location: Kutna Hora</span>
                    <p>
                        The mirror maze offers a great deal of fun for children and grown-ups on a 300 m2 area  in a historical building in the heart of Kutná Hora, right next to the plague column in Šultysova Street. Here you will find a mirror maze with 80 mirrors, a crystal-glass maze with 150 mirrors and clear glass, and a children's maze (for height up to 120cm) with 40 mirrors. On top of that we have 12 fun curved mirrors and a few kaleidoscopes. The mazes are equipped with sophisticated computer-operated colourful lighting with an intensity control, which enhances the effects.
                    </p>
                </div>
            </div>
            <hr>
            <div class="d-flex flex-wrap justify-content-center">
                <div class="col-md-2 col-sm-2 me-md-4 me-sm-4">
                  <img class="col-md-12 col-sm-12 rounded img-fluid img-responsive " src="./src/img/museums.jpg" alt="">
                </div>
                <div class="col-md-9 col-sm-9">
                    <h5>Museums</h5>
                    <span>location: Kutna Hora</span>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam suscipit aliquam eius quod enim, provident possimus molestias fugiat qui doloremque, quas, quos voluptatum est cum laboriosam aperiam sint! Illo, amet.</p>
                </div>
            </div>
            <hr>
            <div class="d-flex flex-wrap justify-content-center">
                <div class="col-md-2 col-sm-2 me-md-4 me-sm-4">
                  <img class="col-md-12 col-sm-12 rounded img-fluid img-responsive " src="./src/img/galaries.jpg" alt="">
                </div>
                <div class="col-md-9 col-sm-9">
                    <h5>Gallaries</h5>
                    <span>location: Kutna Hora</span>
            ...
            <div class="d-flex flex-wrap justify-content-center">
                <div class="col-md-2 col-sm-2 me-md-4 me-sm-4">
                  <img class="col-md-12 col-sm-12 rounded img-fluid img-responsive " src="./src/img/theatre.jpg" alt="">
                </div>
                <div class="col-md-9 col-sm-9">
                    <h5>Kutna Hora Tyl Municipal theatre</h5>
                    <span>location: Kutna Hora</span>
                    <p>
