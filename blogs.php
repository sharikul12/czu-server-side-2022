...
<body>
    ...
    <div class="container">
        ...
        <div class="mt-4 col-md-6 mb-2 container blogPost">
            <button class="float-end btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Write a Post</button>
        </div>
        ...
        ?>
        <hr>
        <div class="container col-md-8 blogPostDetails my-4">
            <?php
            while($row = $results->fetch_assoc())
            {
            ?>
                <div class="p-4 shadow">
                    <span class="text-uppercase"> <strong> <?=$row['uname']?> </strong></span>
                    <br>
                    ...
                    <div class="float-end">
                        ...
                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Post Here</h5>
                                    </div>
                                    <div class="modal-body">
                                        <form action="" class="form-control" method="POST">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" name="submitEdit" class="btn btn-primary">Post Status</button>
                                            </div>
                                        </form>    
                                    </div>
