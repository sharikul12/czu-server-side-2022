<?php
	...
	{	
        ...
        $sql = "INSERT INTO contact (f_name,l_name,email,phone,cmessage) VALUES ('$fName','$lName','$email','$phone','$mess')";
...
<body>
    ...
    <div class="container mt-4">
        <div class="text-center p-5 shadow">
            <h2>Contact us</h2>
            <p class="lead">Subscribe to receive more information and a monthly newsletter.</p>
        </div>
        ...
        <?php 
                ...
                ?>
                        ...
                        <h4 class="alert-heading">Well done!</h4>
                            <p>Yeah, Your query is successfully added. Our team will contact you soon........  </p>
                        </div>
                <?php
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="text" name="firstName" id="firstName" class="form-control" placeholder="max 10 char" maxlength="10" required>

                </div>
                <div class="col mb-3">
                    <label class="form-label">Last Name: </label>
                    <input type="text" name="lastName" id="firstName" class="form-control" placeholder="max 10 char" maxlength="10" required>
            ...
            <div class="row">
                <div class=" col mb-3">
                    ...
                    <input type="email" name="inputEmail" id="inputEmail" class="form-control" placeholder="Type your email here" maxlength="20" required>
                </div>

                <div class="col mb-3">
                    <label class="form-label">Phone: </label>
                    <input type="text" name="inputPhone" id="inputPhone" class="form-control"
                        placeholder="+420-xxx-xxx-xxx" maxlength="12" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="messag" class="form-control" id="inputMessage" maxlength="250" cols="30" rows="5"
