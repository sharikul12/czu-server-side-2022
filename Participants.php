    ...
    <div class="container">
        <div class="d-flex flex-wrap justify-content-center mt-4 text-center">
                <div class="col-md-3 mb-4">
                    <img src="./src/img/faisal.jpeg" class="img-thumbnail img-fluid">
                    <div class="home-info">
                        ...
                        <br>
                        <form method="get" action="./faisal.php">
                            <button class="btn btn-info" type="submit">View More</button>
                        </form>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <img src="./src/img/tripty.jpeg" class="img-thumbnail img-fluid">
                    <div class="home-info">
                        ...
                        <span>Ceska Zemedelska Univerzita</span>
                        <br>
                        <form method="get" action="./tripty.php">
                            <button class="btn btn-info" type="submit">View More</button>
                        </form>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <img src="./src/img/sharik.jpeg" class="img-thumbnail img-fluid">
                    <div class="home-info">
                        ...
                        <span>Ceska Zemedelska Univerzita</span>
                        <br>
                        <form method="get" action="./sharikul.php">
                            <button class="btn btn-info" type="submit">View More</button>
                        </form>
                    </div>
                </div>
